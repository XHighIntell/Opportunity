...
namespace Blite.Indicators {
    ...
    ///<summary>The smallest of values in specified length.</summary>
    public class MIN {

        ///<summary>Initializes a new instance of the <see cref="MIN"/> class with specified length.</summary>
        ...
        public double Moment(double value) {
            ...
            if (sources.Count < period) nextResult = double.NaN;
                ...
                nextResult = sources[sources.Count - period];
